      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-300 mb-4">
            This is a simplified version of the portfolio management interface.
            Please use the main admin page for now as we&apos;re fixing some technical issues.
          </p>
          <div className="flex justify-center">
            <Link 
              href="/admin"
              className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white rounded-lg shadow-sm hover:shadow-md transition-all duration-300"
            >
